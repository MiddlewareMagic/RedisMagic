...
//import github.middlewaremagic.redismagic.command.impl.connection.*;
//import github.middlewaremagic.redismagic.command.impl.hash.*;
//import github.middlewaremagic.redismagic.command.impl.key.*;
//import github.middlewaremagic.redismagic.command.impl.list.*;
//import github.middlewaremagic.redismagic.command.impl.server.*;
//import github.middlewaremagic.redismagic.command.impl.set.*;

import github.middlewaremagic.redismagic.command.impl.string.*;
//import github.middlewaremagic.redismagic.command.impl.zset.*;
